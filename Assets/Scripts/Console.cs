...
namespace Consolation
{
	...
	class Console : MonoBehaviour
	{
		...
		Rect windowRect = new Rect (0/*margin*/, /*margin*/0, Screen.width /*- (margin * 2)*/, Screen.height /*- (margin * 2)*/);
		...
		void DrawLogsList ()
		{
			...
			for (var i = 0; i < logs.Count; i++) {
				...
				GUILayout.Label (log.message/*, new GUIStyle(){fontSize = 42, font = f}*/);
			}
